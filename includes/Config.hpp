...
// bool bracesCheck(const std::string &str);
// bool areLocationsNestedInServers(const std::string &str);
// void trimEdges(std::string &s, const std::string &d);
// void	vecTrim(std::vector<std::string> &lines, const std::string &d);
// void removeEmptyLines(std::vector<std::string> &lines);
// void removeComments(std::string& s);
// bool	elementNumCheck(const std::vector<std::string> &lines);
// bool	elementStrCheck(const std::vector<std::string> &lines);
